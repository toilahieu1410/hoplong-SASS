...
const PrepareComplete = ({navigation, number}) => {
  const dispatch = useDispatch();
  const listDonHang = useSelector(store => store.donHang.listDonHang);
  const [statusCode, setStatusCode] = useState('prepare_complete');
              ...
              <View style={styles.mb}>
                ...
                <View style={styles.flex}>
                  ...
                  <View style={styles.detail}>
                    ...
                    <Text
                      onPress={() =>
                        navigation.navigate('ChiTietDonHang', {data: item.id})
                      }
...
export default PrepareComplete;
